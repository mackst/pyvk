...
class HelloTriangleApplication(QtGui.QWindow):
    ...
    def __createSurface(self):
        if sys.platform == 'win32':
            ...
            print('surface is valid: {}'.format(self.__surface.isValid))
    ...
    def __createSwapChain(self):
        ...
        print('swap chain is valid: {}'.format(self.__swapChain.isValid))
    ...
    def __createImageViews(self):
        ...
        for i, image in enumerate(self.__swapChainImages):
            ...
            print('swap chain image view {} is valid: {}'.format(i, self.__swapChainImageViews[i].isValid))
    ...
    def __createRenderPass(self):
        ...
        print('render pass is valid: {}'.format(self.__renderPass.isValid))
    ...
    def __createGraphicsPipeline(self):
        ...
        print("graphicsPipelines is list: {}".format(isinstance(graphicsPipelines, list)))
        print("pipeline is valid: {}".format(graphicsPipelines[0].isValid))
    ...
    def __createFramebuffers(self):
        ...
        for fb in self.__swapChainFramebuffers:
            print("framebuffer is valid: {}".format(fb.isValid))
    ...
    def __createCommandPool(self):
        ...
        print("commandPool is valid: {}".format(self.__commandPool.isValid))
    ...
    def __createSyncObjects(self):
        ...
        for i in range(len(self.__swapChainFramebuffers)):
            ...
            print("imageAvailableSemaphores is valid: {}".format(self.__imageAvailableSemaphores[i].isValid))
            print("renderFinishedSemaphores is valid: {}".format(self.__renderFinishedSemaphores[i].isValid))
            print("fence is valid: {}".format(self.__inFlightFences[i].isValid))
