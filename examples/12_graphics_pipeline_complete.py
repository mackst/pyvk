...
class HelloTriangleApplication(QtGui.QWindow):
    ...
    def __createGraphicsPipeline(self):
        ...
        self.__graphicsPipeline = self.__device.createGraphicsPipelines(_vk.PipelineCache(), [pipelineInfo, ])
        print("self.__graphicsPipeline is list: {}".format(isinstance(self.__graphicsPipeline, list)))
        print("pipeline is valid: {}".format(self.__graphicsPipeline[0].isValid))
