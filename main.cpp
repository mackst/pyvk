...
PYBIND11_MODULE(_vk, m)
{
	...
	py::enum_<VkPipelineStageFlagBits>(m, "PipelineStageFlagBits")
		.value("TOP_OF_PIPE_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT)
		.value("DRAW_INDIRECT_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT)
		.value("VERTEX_INPUT_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_VERTEX_INPUT_BIT)
		.value("VERTEX_SHADER_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_VERTEX_SHADER_BIT)
		.value("TESSELLATION_CONTROL_SHADER_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT)
		.value("TESSELLATION_EVALUATION_SHADER_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT)
		.value("GEOMETRY_SHADER_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT)
		.value("FRAGMENT_SHADER_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT)
		.value("EARLY_FRAGMENT_TESTS_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT)
		.value("LATE_FRAGMENT_TESTS_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT)
		.value("COLOR_ATTACHMENT_OUTPUT_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT)
		.value("COMPUTE_SHADER_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT)
		.value("TRANSFER_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_TRANSFER_BIT)
		.value("BOTTOM_OF_PIPE_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT)
		.value("HOST_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_HOST_BIT)
		.value("ALL_GRAPHICS_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_ALL_GRAPHICS_BIT)
		.value("ALL_COMMANDS_BIT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_ALL_COMMANDS_BIT)
		.value("TRANSFORM_FEEDBACK_BIT_EXT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_TRANSFORM_FEEDBACK_BIT_EXT)
		.value("CONDITIONAL_RENDERING_BIT_EXT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_CONDITIONAL_RENDERING_BIT_EXT)
		.value("COMMAND_PROCESS_BIT_NVX", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_COMMAND_PROCESS_BIT_NVX)
		.value("SHADING_RATE_IMAGE_BIT_NV", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_SHADING_RATE_IMAGE_BIT_NV)
		.value("RAY_TRACING_SHADER_BIT_NV", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_NV)
		.value("ACCELERATION_STRUCTURE_BUILD_BIT_NV", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_NV)
		.value("TASK_SHADER_BIT_NV", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_TASK_SHADER_BIT_NV)
		.value("MESH_SHADER_BIT_NV", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_MESH_SHADER_BIT_NV)
		.value("FRAGMENT_DENSITY_PROCESS_BIT_EXT", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_FRAGMENT_DENSITY_PROCESS_BIT_EXT)
		.value("FLAG_BITS_MAX_ENUM", VkPipelineStageFlagBits::VK_PIPELINE_STAGE_FLAG_BITS_MAX_ENUM);
	py::enum_<VkAccessFlagBits>(m, "AccessFlagBits")
		.value("INDIRECT_COMMAND_READ_BIT", VkAccessFlagBits::VK_ACCESS_INDIRECT_COMMAND_READ_BIT)
		.value("INDEX_READ_BIT", VkAccessFlagBits::VK_ACCESS_INDEX_READ_BIT)
		.value("VERTEX_ATTRIBUTE_READ_BIT", VkAccessFlagBits::VK_ACCESS_VERTEX_ATTRIBUTE_READ_BIT)
		.value("UNIFORM_READ_BIT", VkAccessFlagBits::VK_ACCESS_UNIFORM_READ_BIT)
		.value("INPUT_ATTACHMENT_READ_BIT", VkAccessFlagBits::VK_ACCESS_INPUT_ATTACHMENT_READ_BIT)
		.value("SHADER_READ_BIT", VkAccessFlagBits::VK_ACCESS_SHADER_READ_BIT)
		.value("SHADER_WRITE_BIT", VkAccessFlagBits::VK_ACCESS_SHADER_WRITE_BIT)
		.value("COLOR_ATTACHMENT_READ_BIT", VkAccessFlagBits::VK_ACCESS_COLOR_ATTACHMENT_READ_BIT)
		.value("COLOR_ATTACHMENT_WRITE_BIT", VkAccessFlagBits::VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT)
		.value("DEPTH_STENCIL_ATTACHMENT_READ_BIT", VkAccessFlagBits::VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT)
		.value("DEPTH_STENCIL_ATTACHMENT_WRITE_BIT", VkAccessFlagBits::VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT)
		.value("TRANSFER_READ_BIT", VkAccessFlagBits::VK_ACCESS_TRANSFER_READ_BIT)
		.value("TRANSFER_WRITE_BIT", VkAccessFlagBits::VK_ACCESS_TRANSFER_WRITE_BIT)
		.value("HOST_READ_BIT", VkAccessFlagBits::VK_ACCESS_HOST_READ_BIT)
		.value("HOST_WRITE_BIT", VkAccessFlagBits::VK_ACCESS_HOST_WRITE_BIT)
		.value("MEMORY_READ_BIT", VkAccessFlagBits::VK_ACCESS_MEMORY_READ_BIT)
		.value("MEMORY_WRITE_BIT", VkAccessFlagBits::VK_ACCESS_MEMORY_WRITE_BIT)
		.value("TRANSFORM_FEEDBACK_WRITE_BIT_EXT", VkAccessFlagBits::VK_ACCESS_TRANSFORM_FEEDBACK_WRITE_BIT_EXT)
		.value("TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT", VkAccessFlagBits::VK_ACCESS_TRANSFORM_FEEDBACK_COUNTER_READ_BIT_EXT)
		.value("TRANSFORM_FEEDBACK_COUNTER_WRITE_BIT_EXT", VkAccessFlagBits::VK_ACCESS_TRANSFORM_FEEDBACK_COUNTER_WRITE_BIT_EXT)
		.value("CONDITIONAL_RENDERING_READ_BIT_EXT", VkAccessFlagBits::VK_ACCESS_CONDITIONAL_RENDERING_READ_BIT_EXT)
		.value("COMMAND_PROCESS_READ_BIT_NVX", VkAccessFlagBits::VK_ACCESS_COMMAND_PROCESS_READ_BIT_NVX)
		.value("COMMAND_PROCESS_WRITE_BIT_NVX", VkAccessFlagBits::VK_ACCESS_COMMAND_PROCESS_WRITE_BIT_NVX)
		.value("COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT", VkAccessFlagBits::VK_ACCESS_COLOR_ATTACHMENT_READ_NONCOHERENT_BIT_EXT)
		.value("SHADING_RATE_IMAGE_READ_BIT_NV", VkAccessFlagBits::VK_ACCESS_SHADING_RATE_IMAGE_READ_BIT_NV)
		.value("ACCELERATION_STRUCTURE_READ_BIT_NV", VkAccessFlagBits::VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NV)
		.value("ACCELERATION_STRUCTURE_WRITE_BIT_NV", VkAccessFlagBits::VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_NV)
		.value("FRAGMENT_DENSITY_MAP_READ_BIT_EXT", VkAccessFlagBits::VK_ACCESS_FRAGMENT_DENSITY_MAP_READ_BIT_EXT)
		.value("FLAG_BITS_MAX_ENUM", VkAccessFlagBits::VK_ACCESS_FLAG_BITS_MAX_ENUM);
	py::enum_<VkDependencyFlagBits>(m, "DependencyFlagBits")
		.value("BY_REGION_BIT", VkDependencyFlagBits::VK_DEPENDENCY_BY_REGION_BIT)
		.value("DEVICE_GROUP_BIT", VkDependencyFlagBits::VK_DEPENDENCY_DEVICE_GROUP_BIT)
		.value("VIEW_LOCAL_BIT", VkDependencyFlagBits::VK_DEPENDENCY_VIEW_LOCAL_BIT)
